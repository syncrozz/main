      ...
      <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 rounded-2xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="flex flex-wrap items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-200 text-xs font-bold flex items-center gap-1.5 backdrop-blur-xs">
              <ShieldCheck className="w-3.5 h-3.5 text-blue-400" />
              <span>Sesi Disahkan Google OAuth 2.0</span>
            </span>

            {isMasterAdmin && (
              <span className="px-3 py-1 rounded-full bg-amber-500 text-slate-950 text-xs font-black flex items-center gap-1.5 shadow-sm">
          ...
          <p className="text-sm text-slate-300 leading-relaxed">
            ...
            {isMasterAdmin 
              ? ' Anda memegang kebenaran Master Admin tertinggi bagi keseluruhan ekosistem SYNCROZZ.' 
              : ' Anda mempunyai hak akses pentadbir untuk mengurus visual dan kandungan platform.'}
          </p>
          ...
          <div className="pt-2 flex flex-wrap gap-3">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-[#0056D2] hover:bg-blue-600 text-white font-bold text-xs shadow-md transition-all flex items-center gap-2 cursor-pointer"
            >
              <ImageIcon className="w-4 h-4" />
              <span>Urus Open Graph Images (JPG)</span>
            </button>

            <button
              id="overview-quick-users-btn"
              onClick={() => onNavigateTab('users')}
              className="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold text-xs border border-white/20 transition-all flex items-center gap-2 cursor-pointer backdrop-blur-xs"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-9 h-9 rounded-xl bg-blue-50 text-[#0056D2] flex items-center justify-center">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-800 group-hover:text-[#0056D2]">
                    Muat Naik OG Image JPG
                  </div>
                  <div className="text-[11px] text-slate-500">
                    Kustom visual 1200×630px
                  </div>
                </div>
              </div>
