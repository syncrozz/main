...
<meta name="twitter:image" content="${imgUrl}" />`;
  ...
  return (
    <div className="space-y-3.5">
      ...
      <div 
        id="admin-platforms-top-header"
        className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm flex flex-col xl:flex-row xl:items-center justify-between gap-4"
      >
        <div className="space-y-1.5 min-w-0 max-w-2xl">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {Object.keys(customOgImages).length > 0 && (
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200">
                {Object.keys(customOgImages).length} Imej OG Kustom
              </span>
            )}
          </div>
          ...
          <p className="text-xs text-slate-500 leading-relaxed break-words">
            Kawal dan kemaskini URL sasaran rasmi, status ketersediaan, serta visual Open Graph bagi setiap produk ekosistem SYNCROZZ dalam masa-nyata.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0 pt-1 xl:pt-0">
          ...
          <div className="flex items-center gap-1 bg-slate-100/90 p-1 rounded-xl border border-slate-200">
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg text-xs font-bold text-slate-700 hover:text-[#0056D2] hover:bg-white transition-all flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <div className="bg-slate-100/90 p-1 rounded-xl border border-slate-200 flex items-center gap-1">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                viewMode === 'list'
                  ? 'bg-white text-[#0056D2] shadow-xs ring-1 ring-slate-200'
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#0056D2] hover:bg-blue-700 text-white text-xs sm:text-sm font-bold shadow-sm transition-all cursor-pointer shrink-0 active:scale-95"
          >
