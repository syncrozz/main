...
export const Footer: React.FC<FooterProps> = ({ 
  ...
  return (
    <footer className="bg-white border-t border-slate-100 pt-10 pb-8 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Top 5-Column Grid */}
        <div className="grid grid-cols-2 md:grid-cols-12 gap-6 lg:gap-8 pb-8 border-b border-slate-100">
          
          {/* Brand Info Column (4 cols) */}
          <div className="col-span-2 md:col-span-4 space-y-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg overflow-hidden shadow-2xs shadow-blue-500/20 shrink-0 bg-white">
                <img 
            ...
            <p className="text-xs text-slate-500 leading-relaxed font-normal max-w-sm">
              Smart Solutions for Education, Productivity & Digital Innovation. Platform bersepadu untuk memperkasa warga pendidik dan institusi.
            </p>
            ...
            <div className="pt-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="w-7 h-7 rounded-md bg-slate-50 hover:bg-blue-50 text-slate-600 hover:text-[#0056D2] flex items-center justify-center transition-colors border border-slate-200/60"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-7 h-7 rounded-md bg-slate-50 hover:bg-red-50 text-slate-600 hover:text-red-600 flex items-center justify-center transition-colors border border-slate-200/60"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="TikTok"
                  className="w-7 h-7 rounded-md bg-slate-50 hover:bg-slate-900 text-slate-600 hover:text-white flex items-center justify-center transition-colors border border-slate-200/60"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-7 h-7 rounded-md bg-slate-50 hover:bg-pink-50 text-slate-600 hover:text-pink-600 flex items-center justify-center transition-colors border border-slate-200/60"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
              ...
              {onAdminClick && (
                <li>
                  <button
                    ...
                    className="text-[#0056D2] hover:underline font-semibold cursor-pointer text-left text-[11px]"
                  >
                    Admin Access
                  </button>
                </li>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-slate-500 font-medium text-xs">
            <a
